...
*/
		...
		$tracktype = $_GET['trackType'];
  		if ($_POST['submit']) {
	  			...
	  			$sql = "INSERT INTO Location(Title,Longitude,Latitude,Description,Createdate,User_ID,Categories_ID,Location_type,Pub_Or_Priva) VALUES('".$_POST['Title']."','".$_POST['Longitude']."','".$_POST['Latitude']."','".$_POST['Description']."','".$my_date."',".$userid.",".$_POST['add_categories_id'].",1,1);";
	  			$result = $dbc->query($sql);
				
	  			if($dbc->affected_rows > 0)
	  			{
					$last_id = mysqli_insert_id($dbc);
					$query = "INSERT INTO AdventureTracksPoints(Track_Type,Locat_ID,User_ID) VALUES('".$tracktype."','".$last_id."','".$userid."')";
					...
					echo "<script type=\"text/javascript\">window.location='map.php?userID=".$userid."&roleID=".$roleid."&trackType=".$tracktype."'</script>";
	  			}else{
