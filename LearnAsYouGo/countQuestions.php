...
$dbc->close();
 ...
 if($roleid == '0'){//normal user
 	if($num_text != '0'){
		$menu_text = '<p> <b>1.Text/Image Questions('.$num_text.')</b>&nbsp;&nbsp;&nbsp;<a style="color:blue" name="text" id="question-type" onclick="viewQuestions(this);return false;">View Questions</a><br/>';
	 }else{
		 $menu_text = '<p><b> 1.Text/Image Questions('.$num_text.')</b><br/>';
	 }
	  if($num_fill != '0'){
		 $menu_fill = '<b>2.Fill-in Blank Questions('.$num_fill.')</b>&nbsp;&nbsp;&nbsp;<a style="color:blue" name="fill" id="question-type" onclick="viewQuestions(this);return false;">View Questions</a><br/>';
	 }else{
		 $menu_fill = '<b>2.Fill-in Blank Questions('.$num_fill.')</b><br/>';
	 }
	  if($num_single!= '0'){
		 $menu_single = '<b>3.Single Choice Questions('.$num_single.')</b>&nbsp;&nbsp;&nbsp;<a style="color:blue" name="single" id="question-type" onclick="viewQuestions(this);return false;">View Questions</a><br/>';
	 }else{
		 $menu_single = '<b>3.Single Choice Questions('.$num_single.')</b><br/>';
	 }
	  if($num_multi != '0'){
		 $menu_multi = '<b>4.Multiple Choice Questions('.$num_multi.')</b>&nbsp;&nbsp;&nbsp;<a style="color:blue" name="multi" id="question-type" onclick="viewQuestions(this);return false;">View Questions</a><br/>';
	 }else{
		 $menu_multi = '<b>4.Multiple Choice Questions('.$num_multi.')</b><br/>';
	 }
	  if($num_match != '0'){
		 $menu_match = '<b>5.Match Questions('.$num_match.')</b>&nbsp;&nbsp;&nbsp;<a style="color:blue" name="match" id="question-type" onclick="viewQuestions(this);return false;">View Questions</a><br/>';
	 }else{
		 $menu_match = '<b>5.Match Order Questions('.$num_match.')</b><br/>';
	 }
	  if($num_order != '0'){
		 $menu_order = '<b>6.Correct Order Questions('.$num_order.')</b>&nbsp;&nbsp;&nbsp;<a style="color:blue" name="order" id="question-type" onclick="viewQuestions(this);return false;">View Questions</a><br/>';
	 }else{
		 $menu_order = '<b>6.Correct Order Questions('.$num_order.')</b><br/>';
	 }
	  if($num_fact != '0'){
		 $menu_fact = '<b>7.Information('.$num_fact.')</b>&nbsp;&nbsp;&nbsp;<a style="color:blue" name="fact" id="question-type" onclick="viewQuestions(this);return false;">View Questions</a><br/></p>';
	 }else{
