...
//,`user_input` = '".$input."'
$query_update = "UPDATE `parkapps`.`singleQuestions` SET `question` = '".$question."', `link` = '".$link."', `image_url1` = '".$url."',`available` = '".$available."',`correct_answer` = '".$correct_answer."',`options` = '".$options."',`user_input` = '".$input."',`response` = '".$response."', `response_wrong` = '".$response_wrong."'WHERE `singleQuestions`.`questionid` = '".$questionid."';";
